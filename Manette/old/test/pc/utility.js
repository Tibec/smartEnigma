...
function listenerSendMessageWhenDisconnect()
{
	socket.onclose = function (e) {
		...
		{	
			alert("connexion retablie");
			//lorsque la connexion est retablie, le client envoie la cle de connexion au serveur
    		sendMsg('101|'+ connexionKey );
    	};
    	*/
	}; 
}
