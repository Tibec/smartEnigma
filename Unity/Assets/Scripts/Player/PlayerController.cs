...
public class PlayerController : MonoBehaviour
{
    ...
    // Animation
    private const string kStandAnim = "Stand";
    private const string kWalkAnim = "Walk";
    private const string kJumpAnim = "Jump";
    private const string kFallAnim = "Fall";
    private const string kCrouchAnim = "Crouch";
