...
public class PlayerControllerEditor : Editor
{
    ...
    {
        PlayerController targetObj = target as PlayerController;
        ...
        if (s_showJumpingParams)
        {
            ...
            EditorGUILayout.PropertyField(serializedObject.FindProperty("m_midAirJumpCount"), new GUIContent("Mid Air Jump ", "How many time the player can jump in the air."));
